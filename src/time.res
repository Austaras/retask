...
@val external delayFloat: (float, unit => 'msg) => Cmd.t = "delay"
@val external sleepFloat: float => Task.t<unit, unit> = "sleep"
...
@val external everyFloat: (float, unit => 'msg) => Sub.t = "every"
